  ...
  return (
    <>
      <DashboardBox gridArea="a">
        <BoxHeader title="Revenue and Expenses" subTitle="top line represents revenue, bottom line represnts expenses" sideText="+4%" />
      ...
      <BoxHeader title="Profit and Revenue" subTitle="top line represents revenue, bottom line represnts expenses" sideText="+4%" />
        <ResponsiveContainer width="100%" height="100%">
          <LineChart
            width={500}
            height={400}
