...
import { CartesianGrid, Line, LineChart, XAxis, YAxis, ZAxis, Tooltip, ResponsiveContainer, PieChart, Pie, Cell, ScatterChart, Scatter } from 'recharts';
  ...
  return (
    <>
      <DashboardBox gridArea="d">
        <BoxHeader title="Operational vs Non-Operational Expenses" subTitle="" sideText="+4%" />
